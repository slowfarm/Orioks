...
public class SecondNumeratorFragment extends Fragment implements ContractSecondNumeratorFragment.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ContractSecondNumeratorFragment.Presenter mPresenter = new PresenterSecondNumeratorFragment(this);
