...
public class TodayFragment extends Fragment implements ContractTodayFragment.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ContractTodayFragment.Presenter mPresenter = new PresenterTodayFragment(this);
